  ...
  return (
    <form className="discovery-launcher" onSubmit={handleSubmit}>
      <details className="config-group" open>
        ...
        <p className="form-help">Core request fields used to initialize discovery.</p>
      ...
      <details className="config-group">
        ...
        <p className="form-help">These are server-side filters. Empty fields are not sent.</p>

        <details className="config-group nested" open>
          <summary>Market state filters</summary>
          <p className="form-help">Lifecycle and structural constraints.</p>
        ...
        <details className="config-group nested" open>
          <summary>Trading activity + fees</summary>
          <p className="form-help">Numeric thresholds on market configuration and fees.</p>
          <div className="section-grid">
            <label>
        ...
        <details className="config-group nested">
          <summary>Time and lifecycle</summary>
          <p className="form-help">Epoch and ISO date constraints.</p>
          <div className="section-grid">
            <label>
        ...
        <details className="config-group nested">
          <summary>Metadata and IDs</summary>
          <p className="form-help">Free-text matching and identifier filters.</p>
          <div className="section-grid">
            <label>
      ...
      <details className="config-group">
        <summary>Live data feed (WebSocket)</summary>
        <p className="form-help">
          Leave WebSocket URL blank to skip live probe and run REST-only discovery.
        </p>
        <div className="section-grid">
          <label>
